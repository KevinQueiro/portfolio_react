    ...
    return (
        <form>
            <fieldset className='edu-form'>
                ...
                <label htmlFor="initdate">Fecha Inicial: <input onChange={handleInputChange} id="initdate" name="initdate" type="text" required className='form-input' /></label>
                <label htmlFor="finaldate">Fecha Final: <input onChange={handleInputChange} id="finaldate" name="finaldate" type="text" required className='form-input' /></label>
